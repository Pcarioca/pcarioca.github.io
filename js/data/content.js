(() => {
  ...
  APP.data.content = {
    en: {
      ...
      heroContact: "Contact",
      utilityViewResume: "View Resume",
      utilityOpenGithub: "Open GitHub",
      utilityOpenLinkedIn: "Open LinkedIn",
      utilityCopyEmail: "Copy Email",
      utilityCopyPhone: "Copy Phone",
      utilitySwitchLanguage: "Switch Language",
      utilityChangeStyle: "Change Style",
      utilityWcaProfile: "WCA Profile",
      utilityBuildLatch: "Build Latch",
      utilityEmailCopied: "Email copied",
      utilityPhoneCopied: "Phone copied",
    ...
    ro: {
      ...
      heroLinkedIn: "LinkedIn",
      heroContact: "Contact",
      utilityViewResume: "Vezi CV-ul",
      utilityOpenGithub: "Deschide GitHub",
      utilityOpenLinkedIn: "Deschide LinkedIn",
      utilityCopyEmail: "Copiază emailul",
      utilityCopyPhone: "Copiază telefonul",
      utilitySwitchLanguage: "Schimbă limba",
      utilityChangeStyle: "Schimbă stilul",
      utilityWcaProfile: "Profil WCA",
      utilityBuildLatch: "Construiește latch-ul",
      utilityEmailCopied: "Email copiat",
      utilityPhoneCopied: "Telefon copiat",
    ...
    de: {
      ...
      heroLinkedIn: "LinkedIn",
      heroContact: "Kontakt",
      utilityViewResume: "Lebenslauf ansehen",
      utilityOpenGithub: "GitHub öffnen",
      utilityOpenLinkedIn: "LinkedIn öffnen",
      utilityCopyEmail: "E-Mail kopieren",
      utilityCopyPhone: "Telefon kopieren",
      utilitySwitchLanguage: "Sprache wechseln",
      utilityChangeStyle: "Stil ändern",
      utilityWcaProfile: "WCA-Profil",
      utilityBuildLatch: "Latch bauen",
      utilityEmailCopied: "E-Mail kopiert",
      utilityPhoneCopied: "Telefon kopiert",
